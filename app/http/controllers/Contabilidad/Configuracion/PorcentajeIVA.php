...
use App\PorcentajeRetencionIVA;

class PorcentajeIVA extends Controller
{
    /**
    ...
    {
        $retencionesIva = PorcentajeRetencionIVA::retenciones()->paginate(5);

        return response()->json(
            view('contabilidad.configuracion.include.tablaIVA', ['retencionesIva'=>$retencionesIva])->render());
    }
    ...
    {
        PorcentajeRetencionIVA::create($request->all());
    ...
    {
        $retencion = PorcentajeRetencionIVA::findOrFail($id);
    ...
    {
        PorcentajeRetencionIVA::destroy($id);

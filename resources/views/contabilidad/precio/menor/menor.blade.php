...
@section('css')
	@include('contabilidad.precio.menor.css.css')
@endsection

@section('encabezadoContenido')
	<h1>Calcular Precio por menor</h1>
@endsection
...
@section('contenido')
	<div class="row">
		...
		<div class="col-xs-12 col-sm-9">
			<form>
				...
				<div class="form-group">
					<button id="CalculoPrecioMenor" class="btn btn-success" type="button">
						Calcular precio
					</button>
				</div>
			</form>
	...
	@include('contabilidad.precio.menor.include.modalPrecioPorMenor')

@endsection

@push('js')
	@include('contabilidad.precio.menor.js.js')
	@include('contabilidad.precio.menor.js.jsPrecioPorMenor')
@endpush